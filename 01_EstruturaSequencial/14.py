...
if peso >= 50:
    excedente = peso - 50
    multa = excedente * 4
    print(f"O total de {peso}kg de peixes execederam {excedente}kg e a multa é de {multa}.")
else:
    print(f"O total de {peso}kg de peixes não excedeu o regulamento, não haverá multa.")
